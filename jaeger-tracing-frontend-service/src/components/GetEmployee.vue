...
export default {
  methods: {
    submit() {
      ...
      const NODEJS_SERVICE_URL = process.env.VUE_APP_NODEJS_SERVICE_URL || "http://localhost:8081/";
      // const NODEJS_SERVICE_URL = "http://a116f494349334ab3b7c18e4a410c2e5-706016891.eu-west-1.elb.amazonaws.com:8081/";
