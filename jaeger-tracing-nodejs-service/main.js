...
async function getSalaryAmount(grade) {
    try {
        ...
        console.log(`get salary traceid: ${currentSpan.spanContext().traceId}`);
        // console.log(min);
...
async function createEmployee(data) {
    try {
        ...
        const currentSpan = api.trace.getSpan(api.context.active());
        console.log(`create employee traceid: ${currentSpan.spanContext().traceId}`);
        return resp.data;
    } catch (err) {
        throw new Error(err.toString());
    } 
...
async function getEmployeeByID(id) {
    try {
        ...
        const currentSpan = api.trace.getSpan(api.context.active());
        console.log(`get employee traceid: ${currentSpan.spanContext().traceId}`);
